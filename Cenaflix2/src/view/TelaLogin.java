...
public class TelaLogin extends javax.swing.JFrame {
    ...
    try {
        ...
        List<Usuario> lista = em.createQuery(
            "SELECT u FROM Usuario u WHERE u.usuario = :u AND u.senha = :s",
            Usuario.class
        )
        .setParameter("u", usuarioDigitado)
        .setParameter("s", senhaDigitada)
        .getResultList();
        ...
        if (!lista.isEmpty()) {
            ...
            // OPERADOR
            } else if (user.getTipo().equalsIgnoreCase("Operador")) {
            ...
            // USUÁRIO
                ...
                tela.btnCadastrar.setEnabled(false);
